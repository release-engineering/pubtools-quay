        ...
        signer_wrapper_entry_point.assert_has_calls(
            [
                ...
                mock.call(
                    ...
                    identity=[
                        "some-registry1.com/target/repo@manifest_list_digest",
                        "some-registry2.com/target/repo@manifest_list_digest",
                        "some-registry1.com/target/repo@sha256:1111111111",
                        "some-registry2.com/target/repo@sha256:1111111111",
                        "some-registry1.com/target/repo@sha256:2222222222",
                        "some-registry2.com/target/repo@sha256:2222222222",
                        "some-registry1.com/target/repo@sha256:3333333333",
                        "some-registry2.com/target/repo@sha256:3333333333",
                        "some-registry1.com/target/repo@sha256:5555555555",
                        "some-registry2.com/target/repo@sha256:5555555555",
                    ],
                ),
                mock.call(
                    config_file="test-config.yml",
                ...
                mock.call(
                    ...
                    identity=[
                        "some-registry1.com/operators/index-image@manifest_list_digest",
                        "some-registry2.com/operators/index-image@manifest_list_digest",
                        "some-registry1.com/operators/index-image@manifest_list_digest",
                        "some-registry2.com/operators/index-image@manifest_list_digest",
                        "some-registry1.com/operators/index-image@sha256:5555555555",
                        "some-registry1.com/operators/index-image@sha256:5555555555",
                        "some-registry2.com/operators/index-image@sha256:5555555555",
                        "some-registry2.com/operators/index-image@sha256:5555555555",
                    ],
                ),
                mock.call(
        ...
        signer_wrapper_entry_point.assert_has_calls(
            [
                ...
                mock.call(
                    ...
                    digest=["fake-digest-0", "fake-digest-0"],
                    identity=[
                        "some-registry1.com/target/repo@fake-digest-0",
                        "some-registry2.com/target/repo@fake-digest-0",
                    ],
                ),
            ]
        )
        ...
        signer_wrapper_entry_point.assert_has_calls(
            [
                ...
                mock.call(
                    ...
                    identity=[
                        "some-registry1.com/namespace/test_repo@sha256:6ef06d8c90c863ba4eb4297f1073ba8cb28c1f6570e2206cdaad2084e2a4715d",
                        "some-registry2.com/namespace/test_repo@sha256:6ef06d8c90c863ba4eb4297f1073ba8cb28c1f6570e2206cdaad2084e2a4715d",
                    ],
                ),
            ]
        )
        ...
        signer_wrapper_entry_point.assert_has_calls(
            [
                ...
                mock.call(
                    ...
                    identity=[
                        "some-registry1.com/operators/index-image@sha256:a1a1a1",
                        "some-registry2.com/operators/index-image@sha256:a1a1a1",
                        "some-registry1.com/operators/index-image@sha256:a1a1a1",
                        "some-registry2.com/operators/index-image@sha256:a1a1a1",
                        "some-registry1.com/operators/index-image@sha256:5555555555",
                        "some-registry1.com/operators/index-image@sha256:5555555555",
